...
adminmadeuserroutes.post("/getchargerbyadminid",user_who_bought_the_charger_details)
...
adminmadeuserroutes.get("/vham",viewallmessages)
//details of a message using their id
adminmadeuserroutes.post("/dsm",details)
//user specific help and support message
...
//update disputeform
adminmadeuserroutes.post("/udf",disputeformupdate)
//getform by adminid
...
//dispute form sttaus update
adminmadeuserroutes.post("/resolvestatus",disputeresolved)
//transaction history
