...
const getbilldatabyadminid = async (req, res) => {
    try {
        const {
            adminid,
            userid,
        ...
        return res.status(200).json({
            message: "Bill data fetched successfully for admin",
            pagination: {
                totalRecords,
                totalPages,
        ...
        logging(
            "error",
            `Error in getbilldatabyadminid: ${error.message}`,
            "getbilldatabyadminid.js"
        );
...
export default getbilldatabyadminid;